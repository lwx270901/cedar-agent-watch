...
// The inner implementation that holds the actual RwLock
struct MemoryPolicyStoreInner {
    policies: RwLock<Policies>,
}

impl MemoryPolicyStoreInner {
    fn new() -> Self {
        Self {
...
// The outer store that can be cloned and shared
#[derive(Clone)]
pub struct MemoryPolicyStore {
    inner: Arc<MemoryPolicyStoreInner>,
}

impl MemoryPolicyStore {
    pub fn new() -> Self {
        Self {
            inner: Arc::new(MemoryPolicyStoreInner::new()),
        }
    }
